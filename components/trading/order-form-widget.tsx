    ...
    return (
        <div className="bg-[#1E1E1E] border border-gray-800 rounded-lg p-3 font-sans text-sm shadow-xl flex flex-col gap-3 min-w-[300px]">
            ...
            <div className="flex border-b border-gray-700">
                {['LIMIT', 'MARKET', 'STOP'].map((tab) => (
                    <button
                        ...
                        className={`flex-1 pb-2 text-xs font-bold transition-colors ${activeTab === tab
            ...
            <div className="flex bg-black p-1 rounded">
                <button
                    onClick={() => setSide('BUY')}
                    className={`flex-1 py-1.5 rounded text-xs font-bold transition-all ${side === 'BUY'
                ...
                <button
                    ...
                    className={`flex-1 py-1.5 rounded text-xs font-bold transition-all ${side === 'SELL'
            ...
            <div className="flex flex-col gap-3">
                ...
                {/* TOTAL & PAYOUT - Hiding per user request */}
                ...
                <button
                    ...
                    className={`w-full py-3 rounded font-bold text-white transition-all shadow-lg text-sm ${isSubmitting ? 'bg-gray-600 cursor-not-allowed' : `${themeBg} hover:opacity-90`
                        }`}
                >
